...
<body>
	...
	<script type="text/javascript">
			 ...
			 function formatBoxStatus(cellvalue)
			 {
				 if(cellvalue=="-1")
					 return "无效";
				 else if(cellvalue=="0")
			 ...
			 function formatTypeCode(cellvalue)
			 {
				 if(cellvalue=="10")
					 return "鞋品";
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"print/boxlist",
					datatype: "json",
					height:350,
					colNames:[' ','ID','名称','长','宽','高','状态','创建日期','更新人'],
					colModel:[
...
// 							formatter:formatTypeCode,
// 							stype:"select",
// 							searchoptions:{sopt:["eq"],value:"-99:全部;10:鞋品;20:服装;30:配件;40:通用"},
// 							editable:true,
// 							edittype:"select",
// 							editoptions:{value:"40:通用;10:鞋品;20:服装;30:配件"}
// 						},
						{name:'name',index:'name', editable:false,searchoptions: {sopt: ['cn']}},
						{name:'length',index:'length',  editable:true,searchoptions: {sopt: ['eq']}},
						{name:'width',index:'width',  editable:true,searchoptions: {sopt: ['eq']}},
						{name:'height',index:'height',  editable:true,searchoptions: {sopt: ['eq']}},
						{name:'boxStatus',index:'boxStatus',sortable:false,
							formatter:formatBoxStatus,
							stype:"select",
						...
						{name:'createDate',index:'createDate', sorttype:"date", editable:false,searchoptions: {dataInit:datePick,sopt: ['eq','le','ge'],attr:{title:"选择日期"}},formatter:'date',
							formatoptions:{srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d'}},
						{name:'createUser',index:'createUser',  editable:false,searchoptions: {sopt: ['eq']}}
					], 
					...
					editurl: basePath+"print/saveOrUpdateBox",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
					autowidth: true			
				});
