	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/listBook",
					datatype: "json",
					height:350,
					colNames:['ID','餐厅名称','用餐人数','用餐日期','用餐时段','状态','订餐日期','订餐人','取消订餐日期'],
					colModel:[
						...
						{name:'number',index:'number',editable:false,searchoptions: {sopt: ['eq']}},
						{name:'dayDate',index:'dayDate', sorttype:"date", editable:false,searchoptions: {dataInit:datePick,sopt: ['eq','le','ge'],attr:{title:"选择日期"}},formatter:'date',
						...
						{name:'bookDateTime',index:'bookDateTime', sorttype:"date", editable:false,searchoptions: {dataInit:datePick,sopt: ['eq','le','ge'],attr:{title:"选择日期"}},formatter:'date',
							formatoptions:{srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d'}},
						{name:'Auser',index:'Auser',  editable:false,searchoptions: {sopt: ['cn']}},
						{name:'cancelDateTime',index:'cancelDateTime', sorttype:"date", editable:false,searchoptions: {dataInit:datePick,sopt: ['eq','le','ge'],attr:{title:"选择日期"}},formatter:'date',
							formatoptions:{srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d'}}
					], 
					...
					gridComplete:function(){
			            ...
			            if(rowNum>0){
			                ...
			                $(this).footerData("set",{"diningRoom_name":"单页合计","number":number});                               //将合计值显示出来
			            }else{
			                $(".ui-jqgrid-sdiv").hide();
			            }
			        },
