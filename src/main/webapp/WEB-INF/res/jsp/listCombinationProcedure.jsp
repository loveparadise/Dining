	...
	<div class="main-container" id="main-container">
		<div class="main-container-inner">
			...
			//将对象数值转换显示中文，在jqgrid定义列对象时用到
			 ...
			 {
				 if(cellvalue==true||cellvalue=="可用")
					 return "可用";
				 else
					 return "不可用";
			 }
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"procedure/listCombinationProcedure",
					datatype: "json",
					height:350,
					colNames:[' ','ID','编码','组合名称','状态'],
					colModel:[
						...
						{name:'code',index:'code', 
							editable:true,
							formatter:"showlink",
	                        formatoptions:{baseLinkUrl:"<%=basePath%>procedure/editCombinationProcedure",idName:'id'},
							searchoptions: {sopt: ['cn']}
						},
						
						{name:'name',index:'name', searchoptions: {sopt: ['cn']}},
						{name:'flag',index:'flag',sortable:false,editable:true,
					...
					editurl: basePath+"procedure/updateCombinationProcedure",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
