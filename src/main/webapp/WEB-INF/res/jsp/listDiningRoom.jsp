...
<body>
	...
	<script type="text/javascript">
			 ...
			 function formatBookFlag(cellvalue)
			 {
				 if(cellvalue=="-1")
					 return "不可订";
				 else if(cellvalue=="0")
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/listDiningRoom",
					datatype: "json",
					height:350,
					colNames:['ID','名称','状态','可用餐人数','是否可订餐','更新日期','更新人'],
					colModel:[
...
// 						},
						...
						{name:'bookFlag',index:'bookFlag',sortable:false,
							formatter:formatBookFlag,
							stype:"select",
							searchoptions:{sopt:["eq"],value:"-99:全部;-1:不可订;0:可订 "},
							editable:true,
							edittype:"select",
							editoptions:{value:"0:可订;-1:不可订"}
						},
					...
					editurl: basePath+"common/saveOrUpdateDiningRoom",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
					autowidth: true			
				});
