...
<body>
	...
	<script type="text/javascript">
			...
			var editDiningRoomStr="";
			 ...
			 function formatRecommend(cellvalue)
			 {
				 if(cellvalue=="1")
					 return "推荐";
				 else if(cellvalue=="0")
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/listMeal",
					datatype: "json",
					height:350,
					colNames:['ID','餐厅名称','分类','菜名','用餐日期','用餐时段','状态','更新日期','更新人','备注','图片','今日推荐'],
					colModel:[
						...
						{name:'menu_name',index:'menu_name',  sorttype:"int", editable:true},
						...
						{name:'picture',index:'picture',  editable:false,searchoptions: {sopt: ['cn']}},
						{name:'recommend',index:'recommend',sortable:false,
							formatter:formatRecommend,
							stype:"select",
							searchoptions:{sopt:["eq"],value:"-99:全部;0:非推荐;1:推荐 "},
							editable:true,
							edittype:"select",
							editoptions:{value:"0:非推荐;1:推荐"}
						},
					], 
					...
					editurl: basePath+"menu/saveOrUpdateMeal",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
					autowidth: true			
				});
