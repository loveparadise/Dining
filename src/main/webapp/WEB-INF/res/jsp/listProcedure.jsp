		...
		<div class="main-container-inner">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"procedure/listProcedure",
					datatype: "json",
					height:350,
					colNames:[' ','ID','工序名','标记'],
					colModel:[
						...
						{name:'id',index:'id',  sorttype:"int", editable:false,search:false,hidden:false},
						{name:'name',index:'name', editable:true,searchoptions: {sopt: ['cn']}},
						{name:'flag',index:'flag',sortable:false,
							formatter:formatPFlag,
							stype:"select",
							searchoptions:{sopt:["eq"],value:"-99:全部;true:可用;false:不可用"},
						    editable:true,
							edittype:"select",
							editoptions:{value:"true:可用;false:不可用"}
						}
					], 
					...
					editurl: basePath+"procedure/updateProcedure",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
