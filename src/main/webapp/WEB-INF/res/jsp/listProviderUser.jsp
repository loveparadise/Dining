		...
		<div class="main-container-inner">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"provideruser/listProviserUser",
					datatype: "json",
					height:350,
					colNames:[' ','ID','种类','供应商号','供应商名','是否可用'],
					colModel:[
						...
						{name:'id',index:'id',  sorttype:"int", editable:false,search:false,hidden:true},
						{name:'typeCode',index:'typeCode',sortable:false,width:100,editable:false,stype:"select",searchoptions:{sopt:["eq"],
							value:"-99:全部;20:服装;10:鞋类;30:配件;00:通用;50:广宣用品;70:服材;80:鞋材;90:其它"}},
						{name:'code',index:'code', editable:true,searchoptions: {sopt: ['cn']}},
					...
					editurl: basePath+"provideruser/editProvider",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
