	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/listType",
					datatype: "json",
					height:350,
					colNames:['ID','名称','状态','更新日期','更新人'],
					colModel:[
...
// 						},
					...
					editurl: basePath+"common/saveOrUpdateType",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
					autowidth: true			
				});
