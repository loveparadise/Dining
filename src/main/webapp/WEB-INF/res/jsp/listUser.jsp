	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/listUser",
					datatype: "json",
					height:350,
					colNames:['ID','姓名','帐号','权限串','状态','更新日期','更新人'],
					colModel:[
						{name:'id',index:'id',  sorttype:"int", editable:false,hidden:true},
						{name:'name',index:'name',editable:true,searchoptions: {sopt: ['cn']}},
						{name:'account',index:'account',editable:true,searchoptions: {sopt: ['cn']}},
						{name:'authority',index:'authority',editable:true,searchoptions: {sopt: ['cn']}},
					...
					editurl: basePath+"common/saveOrUpdateUser",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
					autowidth: true			
				});
