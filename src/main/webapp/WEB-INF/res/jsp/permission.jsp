		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs"">
					<ul class="breadcrumb">
						...
						<li class="active">管理员、供应商权限管理</li>
					</ul>
					<!-- .breadcrumb -->
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height:350,
					colNames:[' ','ID','种类','登录帐号','用户名','供应商','邮箱','注册日期','登录日期','同步日期','帐号类型','权限串','是否可用'],
					colModel:[
						...
						{name:'typeCode',index:'typeCode',width:100,editable:false,stype:"select",searchoptions:{sopt:["eq"],
							value:"-99:全部;20:服装;10:鞋类;30:配件;00:通用;50:广宣用品;70:服材;80:鞋材;90:其它"}},
						{name:'account',index:'account', searchoptions: {sopt: ['cn']}},
						{name:'name',index:'name', searchoptions: {sopt: ['cn']}},
						{name:'providerUser',index:'providerUser', searchoptions: {sopt: ['cn']}},
...
// 						},
						...
						{name:'authority',index:'authority',sortable:false,
					...
					editurl: basePath+"user/updatePermission",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
