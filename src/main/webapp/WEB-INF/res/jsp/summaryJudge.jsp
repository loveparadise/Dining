	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"common/summaryJudge",
					datatype: "json",
					height:350,
					colNames:['ID','餐厅名称','分类','菜名','用餐日期','评分','用餐时段','状态','评价日期','评价人'],
					colModel:[
						...
						{name:'menu_name',index:'menu_name',  sorttype:"int", editable:false,searchoptions: {sopt: ['cn']}},
						...
						{name:'score',index:'score',editable:false,searchoptions: {sopt: ['eq']}},
					...
					gridComplete:function(){
			            ...
			            if(rowNum>0){
			                $(".ui-jqgrid-sdiv").show();
			                var score=$(this).getCol("score",false,"sum");
			                $(this).footerData("set",{"diningRoom_name":"单页合计","score":score});                               //将合计值显示出来
			            }else{
			                $(".ui-jqgrid-sdiv").hide();
			            }
			        },
