		...
		<div class="main-container-inner">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:basePath+"user/userRole",
					datatype: "json",
					height:350,
					colNames:[' ','ID','角色名','角色组','权限串','是否可用'],
					colModel:[
						...
						{name:'role',index:'role', searchoptions: {sopt: ['eq']}},
					...
					editurl: basePath+"user/updateUserRole",//新增，修改，删除所提交的路径，根据不动页面设置 不同值，有可能要动态来改变，达到操作需求
